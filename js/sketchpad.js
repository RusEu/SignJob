	...
	function getOffset( e,canvas ) {
		...
		_htmlLeft = html.offsetLeft;
  		var element = canvas, offsetX = 0, offsetY = 0;		  // Compute the total offset
    ...
    function getMousePos(e) {
     /*   
        ...
        if (e.offsetX) {
      	...
      	mouseX = e.pageX - getOffset(e,canvas).offsetX;
        mouseY = e.pageY - getOffset(e,canvas).offsetY;
     }
    ...
    function getTouchPos(e) {
        ...
        if(e.touches) {
            if (e.touches.length == 1) { // Only deal with one finger
	        	...
	        	touchX = touch.pageX - getOffset(e,canvas).offsetX;
		        touchY = touch.pageY - getOffset(e,canvas).offsetY;
            }
        }
    }
